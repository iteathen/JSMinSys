...
export function createConnect4RbaSharedExactCache32({capacity=65536,keyWords,diagnosticSampleMask=-1}={}){
...
export function probeConnect4RbaSharedExactCache32(cache,words,offset){
  ...
  if(cache.diagnosticSampleMask>=0)
    Atomics.add(cache.stats,(hash&cache.diagnosticSampleBits)?4:3,1);
  return value;
}
