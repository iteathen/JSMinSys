...
export function probeConnect4RbaSharedExactCache32(cache,words,offset,stats=null,statsBase=0){
...
export function storeConnect4RbaSharedExactCache32(cache,words,offset,value,stats=null,statsBase=0){
  const slot=mixSpan32Locator32(words,offset,cache.keyWords)&cache.mask,
