...
const CONTROL_DONE=1,CONTROL_WAKE=3,CONTROL_WINNER=4,
  ...
  sharedStats=new Uint32Array(workerData.sharedStatsBuffer),
  sharedStatsBase=index*workerData.sharedStatsStride,
  state=prepareConnect4RbaAlphaBeta({
    ...
    sharedExactStats:sharedStats,
    sharedExactStatsBase:sharedStatsBase,
